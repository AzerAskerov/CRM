scheduler.locale = {
    date:{
        month_full:["Yanvar", "Fevral", "Mart", "Aprel", "May", "İyun", 
            "İyul", "Avqust", "Sentyabr", "Oktyabr", "Noyabr", "Dekabr"],
        month_short:["Yan", "Fev", "Mar", "Apr", "May", "İyn", 
            "İyl", "Avq", "Sen", "Okt", "Noy", "Dek"],
        day_full:["Bazar", "Bazar ertesi", "Çərşənbə axşamı", "Çərşənbə", "Cümə axşamı", 
            "Cümə", "Şənbə"],
        day_short:["B", "Be", "Ça", "Ç", "Ca", "C", "Ş"]
    },
    labels:{
        ...
        week_tab:"Həftə",
        month_tab:"Ay",
        new_event:"Yeni görüş",
        icon_save:"Yadda saxla",
        icon_cancel:"İmtina",
        icon_details:"Ətraflı",
        icon_edit:"Redaktə",
        icon_delete:"Sil",
        confirm_closing:"",// Your changes will be lost, are your sure?
        confirm_deleting:"Görüş silinəcəkdir, razısınız?",
        section_description:"Açıqlama",
