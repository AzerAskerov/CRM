...
{
    public partial class VehiclePrintOut
    {
        [Parameter]
        ...
        protected async override Task OnParametersSetAsync()
        {
            ...
            if (DealModel != null && OfferModel != null)
            {
               ...
               new DealOfferDropdownDataModel
               {
                ...
                if (responseGeneralResult != null && responseGeneralResult.Model != null)
                {
                ...
                if (Vehicles != null && Vehicles.Count > 0)
                {
                    foreach (var vehicle in Vehicles)
                    {
                        ...
                        if (response != null)
                        {
                            ...
                            vehicle.PersonalAccidentInsuranceOfDriverAndPassengerItems = responseResult?.Model?.PersonalAccidentInsuranceOfDriverAndPassengerItems;
                            vehicle.PropertyLiabilityInsuranceItems = responseResult?.Model?.PropertyLiabilityInsuranceItems;
