...
{
    public partial class ProductLiabilityInsuranceOfferComponent
    {
        [Parameter]
        public ProductLiabilityInsuranceOfferModel OfferModel { get; set; }
        [Parameter]
        ...
        {
            OfferModel ??= new ProductLiabilityInsuranceOfferModel();
