...
{
    public partial class HiringLiabilityInsuranceOfferComponent
    {
        [Parameter]
        public HiringLiabilityInsuranceOfferModel OfferModel { get; set; }
        [Parameter]
        ...
        {
            OfferModel ??= new HiringLiabilityInsuranceOfferModel();
