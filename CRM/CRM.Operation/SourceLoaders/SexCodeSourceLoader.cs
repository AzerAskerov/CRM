...
{
    public class SexCodeSourceLoader : SourceLoader
    {
        public SexCodeSourceLoader()
        {
        }
        ...
        protected override IEnumerable<ISourceItem> DoLoad2(IModel model)
        {
            ...
            foreach (var code in context.Codes.Where(x =>
                x.TypeOid == (int) CodeTypeEnum.SEX_CODE && DateTime.Now > x.ValidFrom && DateTime.Now < x.ValidTo))
            {
